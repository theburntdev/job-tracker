...
public sealed class UpdateJobApplicationValidatorTests
{
    private readonly UpdateJobApplicationValidator _validator = new();

    private static UpdateJobApplicationCommand ValidCommand() =>
        new(Guid.NewGuid(), "Software Engineer", "Acme Corp", null, null, null, Stage.Applied, null, null);
